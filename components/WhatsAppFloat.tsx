...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    <a  href={siteConfig.whatsappUrl}
      ...
      onClick={handleClick}
      className="fixed bottom-8 right-8 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center z-40 shadow-lg hover:scale-110 transition-transform"
    >
